      ...
      return new Vue({
        ...
        methods: {
          ...
          onDetail: () => {
            self.loading = true;
            helper
              .post("/kapital/" + uid + "/analisis/detail")
              .then(function ({ success, data, message }) {
                if (!success) {
                  throw message;
                }
                console.log("OQWDJWQJOIDDWQJIOQWJIO");
                ...
                if (self.typeId == 1) {
                  ...
                  document.getElementById("currencyAnalysisInput").value =
                    "Dólares";
          ...
          onCurrencyCompany: () => {
            ...
            bsGraph.square("bsGroupCard1", {
              q1: {
                title: "Activo",
                text: `Koa = ${self.formatterx100p(self.koa)}`,
                value: self.koa,
              },
              q2: {
                title: "Pasivo",
                text: `Kd(1-T) = ${self.formatterx100p(self.kd)}`,
                value: self.kd,
              },
              q3: {
                title: "Patrimonio",
                text: `Ke = ${self.formatterx100p(self.ke)}`,
                value: self.ke,
              },
            });
          },
          ...
          onFormSector: (e) => {
            ...
            helper
              .post("/kapital/" + uid + "/analisis/costos", formData)
              .then(function ({ success, data, message }) {
                if (!success) {
                  throw message;
                }
