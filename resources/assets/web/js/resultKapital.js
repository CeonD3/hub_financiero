        ...
        methods: {
          ...
          onSectorDetail: () => {
            ...
            bsGraph.square("bsGroup1", {
              q1: {
                title: "Activo",
                text: `Koa = ${self.formatterx100p(self.emergent.koa)}`,
                value: self.emergent.koa,
              },
              q2: {
                title: "Pasivo",
                text: `Kd(1-T) = ${self.formatterx100p(self.emergent.kd)}`,
                value: self.emergent.kd,
              },
              q3: {
                title: "Patrimonio",
                text: `Ke = ${self.formatterx100p(self.emergent.ke)}`,
                value: self.emergent.ke,
              },
            });
            bsGraph.square("bsGroup2", {
              q1: {
                title: "Activo",
                text: `Koa = ${self.formatterx100p(self.developed.koa)}`,
                value: self.developed.koa,
              },
              q2: {
                title: "Pasivo",
                text: `Kd(1-T) = ${self.formatterx100p(self.developed.kd)}`,
                value: self.developed.kd,
              },
              q3: {
                title: "Patrimonio",
                text: `Ke = ${self.formatterx100p(self.developed.ke)}`,
                value: self.developed.ke,
              },
            });
          },
          onCompanyDetail: () => {
          ...
          onCurrencyCompany: () => {
            ...
            bsGraph.square("bsGroupCard1", {
              q1: {
                title: "Activo",
                text: `Koa = ${self.formatterx100p(company.koa)}`,
                value: company.koa,
              },
              q2: {
                title: "Pasivo",
                text: `Kd(1-T) = ${self.formatterx100p(company.kd)}`,
                value: company.kd,
              },
              q3: {
                title: "Patrimonio",
                text: `Ke = ${self.formatterx100p(company.ke)}`,
                value: company.ke,
              },
            });
          },
