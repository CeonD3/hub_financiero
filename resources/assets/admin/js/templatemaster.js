    ...
    return new Vue({
      ...
      methods: {
        ...
        onList: function () {
          sweet2.loading();
          fetch(
            window.AppFinanceAdmin.api + "/api/admin/master/templates/list",
            { method: "GET" }
          )
            .then(function (res) {
              return res.json();
        ...
        onSaveProcess: function () {
          sweet2.question({
            ...
            onOk: function () {
              ...
              fetch(
                window.AppFinanceAdmin.api +
                  "/api/admin/master/templates/save-process",
                ...
                .then(function ({ success, data, message }) {
                  ...
                  bootstrap.Modal.getOrCreateInstance(
                    document.getElementById("modalTemplateMaster")
                  ).hide();
                  sweet2.show({
                    type: "success",
                    title: message,
        ...
        onSave: function (e) {
          ...
          sweet2.question({
            ...
            onOk: function () {
              sweet2.loading();
              fetch(
                window.AppFinanceAdmin.api + "/api/admin/master/templates/save",
                { method: "POST", body: formData }
              )
                .then(function (res) {
                  return res.json();
                ...
                .then(function ({ success, data, message }) {
                  ...
                  const { eliminados, existentes, nuevos } =
                    data.merge_template_structures;
                  self.request = {
                  ...
                  bootstrap.Modal.getOrCreateInstance(
                    document.getElementById("mdlForm")
                  ).hide();
                  ...
                  const containerResponses = document.querySelectorAll(
                    ".container-response"
                  );
        ...
        onForm: function (index) {
          ...
          document.getElementById("lblFile").innerText = self.template.file
            ? self.template.file
            : "Seleccionar Archivo";
          bootstrap.Modal.getOrCreateInstance(
            document.getElementById("mdlForm")
        ...
        onDelete: function (index) {
          ...
          sweet2.question({
            ...
            onOk: function () {
              ...
              fetch(
                window.AppFinanceAdmin.api +
                  "/api/admin/master/templates/remove",
                { method: "POST", body: formData }
              )
                .then(function (res) {
                  return res.json();
