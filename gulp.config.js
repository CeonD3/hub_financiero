const gulpConfig = {
    ...
    config: {
        ...
        path: {
            src: "./resources/assets/metronic.v8.1.6/template07/src",
            common_src: "./resources/assets/metronic.v8.1.6/template07/src",
            node_modules: "node_modules",
        },
        dist: ["./resources/assets/metronic.v8.1.6/template07/dist"],
    },
    build: {
        base: {
            src: {
